...
const Login = () => {
  ...
  return (
    <section className="flexCenter px-4 min-h-[70vh] bg-slate-100 overflow-hidden">
    <main className="sm:min-w-[340px] min-w-full shadow-2xl py-6 px-10 border-2 border-gray-300 mt-[5vh] rounded-xl font-bold text-sm bg-white">
      <form onSubmit={handleSignUp}>
        ...
        <h2 className="text-sm mt-5">
          ...
          <span
            ...
            className="hover-cursorCSS text-blue-500 cursor-pointer"
          >
            Sign Up
          </span>
        </h2>
      ...
      <button
          className="hover-cursorCSS text-xs mt-5 text-slate-500 cursor-pointer"
          onClick={hlp}
